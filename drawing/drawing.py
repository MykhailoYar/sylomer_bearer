...
from drawing.vibromat_super import vibromat
    ...
    for s in alls:
        ...
        if len(s) == 0:
            ...
            for i in range(0, len(s)):
                if i == 0:
                    ...
                    if s[i][4] != s[i - 1][4]:
                        ...
                        names = '\n' + str(int(s[i][3])) + ' x ' + str(int(s[i][4])) + ' x ' + str(
                            int(s[i][0])) + ' - ' + str(int(s[i][2])) + ' шт'
                        last = draw(coor, 1500, 1200, 0, name, plus, str(int(s[i][1])), number, general, names,
                                    directory)
                        general = []
                        number += 1
                        q = 1
            ...
            if q == 0:
                ...
                last = draw(coor, 1500, 1200, 0, name, plus, str(int(s[i][1])), number, general, names, directory)
                q = 1
                plus += last
                general = []
                names = ' '
