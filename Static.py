import numpy
def measure(length, width, n, m, energy, thickness,filez,price,sr,inform):
    g = 9.81
    out = []
    interval = numpy.arange(0.3, 10.1, 0.1)
...
# str(length)+' x '+ str(width)+' x '+str(i)
